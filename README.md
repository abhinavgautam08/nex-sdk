...
```html
<!-- Video Player -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-stream/nex-stream.min.js"></script>

<!-- Lazy Image -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-image/nex-image.min.js"></script>

<!-- File Card Previewer -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-file/nex-file.min.js"></script>

<!-- Drag & Drop Uploader -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-upload/nex-upload.min.js"></script>

<!-- UI Elements Bundle -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-ui/nex-ui.min.js"></script>

<!-- Telemetry Analytics -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-analytics/nex-analytics.min.js"></script>

<!-- Terminal Shell -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-terminal/nex-terminal.min.js"></script>

<!-- Telemetry Chart -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-chart/nex-chart.min.js"></script>

<!-- Glitch Router -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-router/nex-router.min.js"></script>

<!-- Authentication Portal -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-auth/nex-auth.min.js"></script>

<!-- Chat Terminal -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-chat/nex-chat.min.js"></script>

<!-- Notification Toasts -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-notification/nex-notification.min.js"></script>

<!-- Checkout Gateway -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-payment/nex-payment.min.js"></script>

<!-- Rich WYSIWYG Editor -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-editor/nex-editor.min.js"></script>

<!-- Canvas QR Generator -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-qr/nex-qr.min.js"></script>

<!-- Camera Viewport -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-camera/nex-camera.min.js"></script>

<!-- Scan Overlay Targets -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-scanner/nex-scanner.min.js"></script>

<!-- Link Sharing Hub -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-share/nex-share.min.js"></script>

<!-- Theme Persister Switch -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-theme/nex-theme.min.js"></script>

<!-- Encryption Storage Cache -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-storage/nex-storage.min.js"></script>

<!-- Latency Connection Monitor -->
<script src="https://cdn.jsdelivr.net/gh/abhinavgautam08/nex-sdk@v1.3.1/packages/nex-network/nex-network.min.js"></script>
```
...
*   **Exact Patch Pin (Safest for Production)**: `abhinavgautam08/nex-sdk@v1.3.1`
