/*! nex-payment v1.3.0 | (c) 2026 NEX SDK | MIT License */class NexPayment extends HTMLElement{static get observedAttributes(){return["logo"]}constructor(){super(),this.price=100,this.discount=0,this.couponCode="",this.activeMethod="card",this.attachShadow({mode:"open"})}connectedCallback(){this.render(),this.attachEvents()}disconnectedCallback(){}attributeChangedCallback(e,a,t){if(e==="logo"&&this.shadowRoot){const o=this.shadowRoot.querySelector(".nex-badge-logo");o&&(o.src=t||"../logo/logo.webp")}}applyCoupon(e){this.couponCode=e.toUpperCase(),this.couponCode==="CYBER"?(this.discount=20,this.dispatchEvent(new CustomEvent("coupon-applied",{detail:{code:"CYBER",discount:20}}))):(this.discount=0,this.dispatchEvent(new CustomEvent("coupon-error",{detail:{code:e}}))),this.render(),this.attachEvents()}setMethod(e){this.activeMethod=e,this.render(),this.attachEvents()}attachEvents(){const e=this.shadowRoot;e.querySelectorAll(".method-tab").forEach(i=>{i.addEventListener("click",()=>{this.setMethod(i.dataset.method)})});const a=e.querySelector("#coupon"),t=e.querySelector(".coupon-btn");if(t&&a&&t.addEventListener("click",()=>{this.applyCoupon(a.value.trim())}),this.activeMethod==="card"){const i=e.querySelector("#cardNum"),r=e.querySelector("#cardName"),n=e.querySelector("#cardExpiry"),s=e.querySelector(".v-card-number"),d=e.querySelector(".v-card-name"),l=e.querySelector(".v-card-expiry");i&&s&&i.addEventListener("input",()=>{s.textContent=i.value||"\u2022\u2022\u2022\u2022 \u2022\u2022\u2022\u2022 \u2022\u2022\u2022\u2022 \u2022\u2022\u2022\u2022"}),r&&d&&r.addEventListener("input",()=>{d.textContent=r.value.toUpperCase()||"CARDHOLDER NAME"}),n&&l&&n.addEventListener("input",()=>{l.textContent=n.value||"MM/YY"})}const o=e.querySelector(".submit-btn");o&&o.addEventListener("click",i=>{i.preventDefault(),this.handleSubmit()})}handleSubmit(){const a=this.shadowRoot.querySelectorAll("input"),t={method:this.activeMethod,amount:this.price-this.discount};a.forEach(o=>{o.id&&(t[o.id]=o.value)}),this.dispatchEvent(new CustomEvent("payment-submit",{detail:{data:t}})),window.showNexToast&&window.showNexToast("TRANSACTION AUTHORIZED // SECURE UPLINK SUCCESSFUL","success",3e3)}render(){const e=this.getAttribute("logo")||"../logo/logo.webp",a=this.price-this.discount;let t="";this.activeMethod==="card"?t=`
      ...
      <div class="payment-wrapper">
        ...
        <div class="summary-box">
          ...
          <div class="summary-row row-total"><span>TOTAL AMOUNT DUE</span><span>$${a.toFixed(2)}</span></div>
        </div>
